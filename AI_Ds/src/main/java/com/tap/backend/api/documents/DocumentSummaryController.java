...
public class DocumentSummaryController {
  ...
  public DocumentSummaryController(SummaryService summaryService, AuditService auditService,
  ...
  public ApiResponse<Map<String, Object>> summary(
    ...
    var res = summaryService.summarizeDocument(resolved.userId(), docId, force);
    auditService.record(resolved, AuditAction.SUMMARY_DOCUMENT, "Document", String.valueOf(docId),
